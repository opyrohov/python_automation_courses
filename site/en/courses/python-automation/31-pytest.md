# Lecture 31: Integration with Pytest
...
pytest --browser chromium --browser firefox  # all
...
# Run
pytest -n auto           # auto number of workers
...
::: tip Exercise 1
Set up pytest-playwright for your project.
:::

::: tip Exercise 2
Create tests with different fixtures for authenticated/anonymous users.
:::

[Code examples on GitHub](https://github.com/opyrohov/python_automation_courses/tree/main/courses/python-automation/Lecture_31_Pytest_Integration/examples)
